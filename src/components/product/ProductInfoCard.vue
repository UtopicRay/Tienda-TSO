  ...
  <div class="flex flex-col gap-4">
    <div class="relative">
      <img
        ...
        alt="product-image"
        class="max-w-[222.4px] h-[200px] mx-auto"
      />
      <span
    ...
    <div class="flex flex-col gap-2">
      <p class="text-neutral">{{ product?.title }}</p>
      <div class="flex gap-2">
        <p class="font-bold text-secundary-blue">$ {{ discountPrice.toPrecision(4) }}</p>
        <p class="line-through text-light-red-2">$ {{ product?.price }}</p>
